---
name: cloudinary-node-quickstart
description: >
  Cloudinary Node.js 5-minute quick start — configure SDK, upload first asset,
  generate transformation URL. Load for minimal server-side integration validation.
license: MIT
metadata:
  author: cloudinary
  hub: cloudinary
...
You can find the full code example for this quick start on [GitHub](https://github.com/cloudinary-devs/cld-node-sdk-quick-start).
