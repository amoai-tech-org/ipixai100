---
title: MCP overview — Mastra
description: Load when wiring MCPClient or MCPServer with Mastra agents. Vendor doc paste — verify APIs in embedded-docs or mastraDocs MCP.
parent: mastra
impact: HIGH
impactDescription: MCP client/server with agents
tags: mastra, mcp, tools
mdeapp: verify-before-code
---
