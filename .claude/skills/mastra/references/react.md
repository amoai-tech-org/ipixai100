---
title: Mastra + React + Vite
description: Load for React/Next.js + Mastra starter patterns.
parent: mastra
impact: MEDIUM
impactDescription: Agent server with AI SDK UI chat patterns
tags: mastra, react, vite, ai-sdk-ui
---
