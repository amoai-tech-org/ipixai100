---
title: MCP Apps — Mastra Studio
description: Load when tools need interactive HTML UIs in Studio via ui:// resources. Post-MVP unless building Studio tooling.
parent: mastra
impact: MEDIUM
impactDescription: MCP Apps extension in Studio
tags: mastra, mcp, studio
mdeapp: phase2
---
