---
title: Mastra workspaces — filesystem and sandbox
description: Load for Mastra workspace config, BrowserViewer, or workspace CLI.
parent: mastra
impact: MEDIUM
impactDescription: Persistent agent env, workspace tools, LocalSandbox pattern
tags: mastra, workspace, sandbox, filesystem
---
