...
new CopilotRuntime({
  ...
  a2ui, // A2UIConfig (optional)             — see ../a2ui-renderer.md
...
| Enabling durable threads + realtime websocket via CopilotKit Intelligence (cloud-hosted or licensed self-hosted)                                                           | `references/intelligence-mode.md`                                                                                                                                                                                                                                                                                                                  |
