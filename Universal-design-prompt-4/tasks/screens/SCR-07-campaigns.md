...
| **Priority** | P2 |
| **Status** | 🔴 ~5% stub |
| **Linear** | [IPI-249](https://linear.app/amo100/issue/IPI-249) |
| **Dependencies** | BE-D1 (IPI-268 campaigns schema) · SC5 CampaignCard |
| **Branch** | `ipi/ipi-249-campaigns-ui` |
| **Matrix** | [MATRIX.md](./MATRIX.md) |
| **Wireframe** | [./wireframes/SCR-07-campaigns.md](./wireframes/SCR-07-campaigns.md) |
| **Diagram** | [./diagrams/SCR-07-campaigns.md](./diagrams/SCR-07-campaigns.md) |
...
| Field | Value |
|---|---|
| **HTML source** | `Pages/Campaigns.v2.image-first.dc.html` |
| **React route** | `/app/campaigns` |
| **Page file** | `app/src/app/(operator)/app/campaigns/page.tsx` |
| **Route status** | **existing** |
| **Scope note** | Blocked on BE-D1 — layout after schema lands. |
...
| Asset | Path |
|---|---|
| **DC SSOT** | [`Pages/Campaigns.v2.image-first.dc.html`](../../Pages/Campaigns.v2.image-first.dc.html) |
| **Wireframe** | [./wireframes/SCR-07-campaigns.md](./wireframes/SCR-07-campaigns.md) |
| **Mermaid** | [./diagrams/SCR-07-campaigns.md](./diagrams/SCR-07-campaigns.md) |
...
- **DC:** [`../../Pages/Campaigns.v2.image-first.dc.html`](../../Pages/Campaigns.v2.image-first.dc.html)
- **Index:** [`../../HTML.md`](../../HTML.md)
- **Discipline:** [`../../plan/designtoreact.md`](../docs/designtoreact.md)

## Files to inspect

- `app/src/app/(operator)/app/campaigns/page.tsx`
- `app/src/components/section-placeholder.tsx`

## Files likely to modify

- `campaigns/page.tsx`
- `app/src/components/campaigns/ (new)`
- `app/src/lib/campaigns/ (new)`

## Supabase dependency

campaigns table + RLS (IPI-268) — NOT on remote yet

## AI dependency

campaign agent (future) — read-only first
...
- [ ] Replace SectionPlaceholder with CampaignCard grid
- [ ] List campaigns from Supabase after D1 merged
- [ ] EmptyState when no campaigns
- [ ] Blocked until BE-D1 lands

## Verification

```bash
cd app && npm run lint && npm test -- campaigns
```

## Risk

High — blocked on migration

## Notes

Route exists but is SectionPlaceholder stub.
