...
| **Priority** | P1 |
| **Status** | 🟡 stub (~10%) |
| **Linear** | [IPI-396](https://linear.app/amo100/issue/IPI-396) · parent IPI-392 · blocked by IPI-395 |
| **Dependencies** | SC1 StatusChip · T1 EntityList · T2 Profile360 · CRM4 |
| **Branch** | `ipi/scr-31-crm-deal-detail` |
| **Matrix** | [MATRIX.md](./MATRIX.md) |
| **Wireframe** | [./wireframes/SCR-31-crm-deal-detail.md](./wireframes/SCR-31-crm-deal-detail.md) |
| **Diagram** | [./diagrams/SCR-31-crm-deal-detail.md](./diagrams/SCR-31-crm-deal-detail.md) |
...
| Field | Value |
|---|---|
| **HTML source** | `Pages/SCR-31-CRM-Deal-Detail.dc.html` |
| **React route** | `/app/crm/pipeline/[id]` |
| **Page file** | `app/src/app/(operator)/app/crm/pipeline/[id]/page.tsx` |
| **Route status** | **existing** |
| **Scope note** | Won/lost HITL — ApprovalCard + convert route. |
...
| Asset | Path |
|---|---|
| **DC SSOT** | [`Pages/SCR-31-CRM-Deal-Detail.dc.html`](../../Pages/SCR-31-CRM-Deal-Detail.dc.html) |
| **Wireframe** | [./wireframes/SCR-31-crm-deal-detail.md](./wireframes/SCR-31-crm-deal-detail.md) |
| **Mermaid** | [./diagrams/SCR-31-crm-deal-detail.md](./diagrams/SCR-31-crm-deal-detail.md) |
...
- **DC:** [`../../Pages/SCR-31-CRM-Deal-Detail.dc.html`](../../Pages/SCR-31-CRM-Deal-Detail.dc.html)
- **Index:** [`../../HTML.md`](../../HTML.md)
- **Discipline:** [`../../plan/designtoreact.md`](../docs/designtoreact.md)

## Files to inspect

- `app/src/app/(operator)/app/crm/pipeline/[id]/page.tsx`
- `app/src/components/crm/crm-screen-gate.tsx`

## Files likely to modify

- `app/(operator)/app/crm/pipeline/[id]/page.tsx`
