...
| **Priority** | P1 |
| **Status** | 🟡 stub (~10%) |
| **Linear** | [IPI-390](https://linear.app/amo100/issue/IPI-390) · parent IPI-388 |
| **Dependencies** | SC1 StatusChip · T1 EntityList · T2 Profile360 · CRM1 |
| **Branch** | `ipi/scr-28-crm-contacts` |
| **Matrix** | [MATRIX.md](./MATRIX.md) |
| **Wireframe** | [./wireframes/SCR-28-crm-contacts.md](./wireframes/SCR-28-crm-contacts.md) |
| **Diagram** | [./diagrams/SCR-28-crm-contacts.md](./diagrams/SCR-28-crm-contacts.md) |
...
| Field | Value |
|---|---|
| **HTML source** | `Pages/SCR-28-CRM-Contacts-List.dc.html` |
| **React route** | `/app/crm/contacts` |
| **Page file** | `app/src/app/(operator)/app/crm/contacts/page.tsx` |
| **Route status** | **existing** |
| **Scope note** | Replace CrmScreenGate — EntityList. |
...
| Asset | Path |
|---|---|
| **DC SSOT** | [`Pages/SCR-28-CRM-Contacts-List.dc.html`](../../Pages/SCR-28-CRM-Contacts-List.dc.html) |
| **Wireframe** | [./wireframes/SCR-28-crm-contacts.md](./wireframes/SCR-28-crm-contacts.md) |
| **Mermaid** | [./diagrams/SCR-28-crm-contacts.md](./diagrams/SCR-28-crm-contacts.md) |
...
- **DC:** [`../../Pages/SCR-28-CRM-Contacts-List.dc.html`](../../Pages/SCR-28-CRM-Contacts-List.dc.html)
...
- `app/(operator)/app/crm/contacts/page.tsx`
