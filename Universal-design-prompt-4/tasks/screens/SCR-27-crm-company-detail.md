...
| **Priority** | P1 |
| **Status** | 🟡 stub (~10%) |
| **Linear** | [IPI-393](https://linear.app/amo100/issue/IPI-393) · parent IPI-391 |
| **Dependencies** | SC1 StatusChip · T1 EntityList · T2 Profile360 · CRM2 |
| **Branch** | `ipi/scr-27-crm-company-detail` |
| **Matrix** | [MATRIX.md](./MATRIX.md) |
| **Wireframe** | [./wireframes/SCR-27-crm-company-detail.md](./wireframes/SCR-27-crm-company-detail.md) |
| **Diagram** | [./diagrams/SCR-27-crm-company-detail.md](./diagrams/SCR-27-crm-company-detail.md) |
...
| Field | Value |
|---|---|
| **HTML source** | `Pages/SCR-27-CRM-Company-Detail.dc.html` |
| **React route** | `/app/crm/companies/[id]` |
| **Page file** | `app/src/app/(operator)/app/crm/companies/[id]/page.tsx` |
| **Route status** | **existing** |
| **Scope note** | Profile360 extract target — build page then extract. |
...
| Asset | Path |
|---|---|
| **DC SSOT** | [`Pages/SCR-27-CRM-Company-Detail.dc.html`](../../Pages/SCR-27-CRM-Company-Detail.dc.html) |
| **Wireframe** | [./wireframes/SCR-27-crm-company-detail.md](./wireframes/SCR-27-crm-company-detail.md) |
| **Mermaid** | [./diagrams/SCR-27-crm-company-detail.md](./diagrams/SCR-27-crm-company-detail.md) |
...
- **DC:** [`../../Pages/SCR-27-CRM-Company-Detail.dc.html`](../../Pages/SCR-27-CRM-Company-Detail.dc.html)
...
- `app/(operator)/app/crm/companies/[id]/page.tsx`
