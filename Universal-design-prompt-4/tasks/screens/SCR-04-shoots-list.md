...
| **Priority** | P1 |
| **Status** | ✅ ~85% |
| **Linear** | [IPI-372](https://linear.app/amo100/issue/IPI-372) Done |
| **Dependencies** | — |
| **Branch** | `ipi/scr-04-shoots-list-polish` |
| **Matrix** | [MATRIX.md](./MATRIX.md) |
| **Wireframe** | [./wireframes/SCR-04-shoots-list.md](./wireframes/SCR-04-shoots-list.md) |
| **Diagram** | [./diagrams/SCR-04-shoots-list.md](./diagrams/SCR-04-shoots-list.md) |
...
| Asset | Path |
|---|---|
| **DC SSOT** | [`Pages/Shoots List.v2.image-first.dc.html`](../../Pages/Shoots%20List.v2.image-first.dc.html) |
| **Wireframe** | [./wireframes/SCR-04-shoots-list.md](./wireframes/SCR-04-shoots-list.md) |
| **Mermaid** | [./diagrams/SCR-04-shoots-list.md](./diagrams/SCR-04-shoots-list.md) |
...
- **DC:** [`../../Pages/Shoots List.v2.image-first.dc.html`](../../Pages/Shoots List.v2.image-first.dc.html)
...
- `app/src/components/shoot/`

## Files likely to modify

- `FilterBar extract if inline`
- `ShootCard polish`
...
Suggested next shoot actions in IntelligencePanel
...
- [ ] ShootCard list matches DC
- [ ] Status filters work
- [ ] Navigate to detail/wizard

## Verification

```bash
cd app && npm test -- shoot
```
...
Done in Linear. Minor polish OK.
