...
begin
  ...
  if not exists (
    ...
    where ns.nspname = 'public'
      and pr.proname = 'campaign_deliverables_block_cross_org_reparent'
    ...
    raise exception 'campaign_deliverables_block_cross_org_reparent must have empty search_path';
  end if;
